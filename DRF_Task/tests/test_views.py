...
class BookViewSetTestCase(TestCase):
    def setUp(self):
        ...
        self.view = BookViewSet.as_view({'get': 'retrieve','post': 'create','put':'update','patch':'partial_update'})
        self.user = get_user_model().objects.create_user(email='zain@gmail.com',name='zain', password='admin', is_author=True)
        self.book_data = {'id':'1','title': 'Test Book','description':'xyz','cover_img': '/media/images/att_Nctgurx.jpg', 'author': '3','in_stock':'True','created':'2023-12-26'}
        self.b_data = {'title': 'Test Book','created':'2023-12-26'}
        self.book = Book.objects.create(title='Test Book', author=self.user,created='2023-12-26')
